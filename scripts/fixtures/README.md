...
`curriculum.bad.mjs` declares four complete lessons, each engineered to trip exactly ONE
check. The lessons dir `lessons-bad/` supplies the markdown that triggers them.

| Check (INFRA-01 / INFRA-04) | Curriculum entry | Markdown fixture | What's wrong |
| --- | --- | --- | --- |
