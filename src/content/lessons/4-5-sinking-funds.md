...
phase: 4
order: 5
title: "Sinking funds: saving for what you know is coming"
summary: "Some big bills aren't surprises — they're scheduled. Setting aside a little each month for the costs you can see coming keeps them from blowing up your budget."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "List your known-but-irregular costs for the year (insurance, holidays, car registration, an annual subscription). Add them up, divide by 12, and start setting that much aside each month."
keepThis: "A sinking fund turns a scary once-a-year bill into a calm monthly habit. Divide the cost by 12 and save it before it's due."
quiz:
  - q: "What is a sinking fund?"
    options:
      - "An account that's losing money"
      - "Money you set aside a little at a time for a known, irregular cost that's coming"
      - "A loan you take out for emergencies"
    answer: 1
    explain: "A sinking fund is planned saving for a cost you can see coming — like insurance or the holidays — broken into small monthly amounts so it never hits all at once."
  - q: "Your car insurance is $1,200, billed once a year. How do you 'sinking-fund' it?"
    options:
      - "Wait until the bill arrives and hope you have the cash"
      - "Set aside $100 a month so the full $1,200 is ready when it's due"
      - "Put it on a credit card and pay interest"
    answer: 1
    explain: "$1,200 ÷ 12 = $100 a month. Save that quietly all year and the once-a-year bill is already paid for before it lands."
  - q: "How is a sinking fund different from an emergency fund?"
    options:
      - "They're exactly the same thing"
      - "A sinking fund is for expected costs you can plan; an emergency fund is for true surprises"
      - "A sinking fund is only for rich people"
    answer: 1
    explain: "A sinking fund covers known, scheduled costs. An emergency fund (Phase 5) covers the genuinely unexpected. Keeping them separate protects both."
sources:
  - label: "CFPB — Use a bill calendar to help manage your monthly expenses"
