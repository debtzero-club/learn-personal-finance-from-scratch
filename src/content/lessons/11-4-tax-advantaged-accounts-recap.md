...
phase: 11
order: 4
title: "Tax-advantaged accounts recap — how to legally pay less"
...
1. **The match first.** It's an instant 100% return; nothing else comes close.
2. **Then the HSA, if you're on an HDHP.** Triple tax advantage, yours forever.
3. **Then more 401(k) or IRA as the budget allows**, using the Roth-vs-traditional timing logic from lesson 10.3.
