...
summary: "A simple default split of your take-home pay — half to needs, a third to wants, a fifth to saving and debt — that gives you a budget in about two minutes."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "Take your monthly take-home pay and do the three-line math: multiply by 0.5, 0.3, and 0.2. Those are your starting targets for needs, wants, and saving + debt. Write them down."
keepThis: "50/30/20 is a starting line, not a rule: 50% needs, 30% wants, 20% saving + debt — of your take-home pay, not your salary."
quiz:
  - q: "In the 50/30/20 split, what does the 20% go toward?"
    options:
      - "Wants and entertainment"
      - "Saving and paying down debt"
      - "Rent and groceries"
    answer: 1
    explain: "The 20% is your future: building savings and knocking down debt. The 50% covers needs, the 30% covers wants."
  - q: "50/30/20 is a percentage of what number?"
    options:
      - "Your gross salary"
      - "Your take-home (net) pay — what actually lands in your account"
      - "Your credit limit"
    answer: 1
    explain: "Always split your take-home pay, not your salary. You can only divide up the money that actually reaches you after taxes and deductions."
  - q: "Your rent and essentials eat up 60% of your take-home, not 50%. What should you do?"
    options:
      - "Give up on budgeting entirely"
      - "Treat 50/30/20 as a starting point and adjust the percentages to your real life"
      - "Stop paying rent"
    answer: 1
    explain: "The ratios are a default, not a law. High rent is common early on — shift the split (maybe 60/20/20) and aim to nudge it back over time."
sources:
