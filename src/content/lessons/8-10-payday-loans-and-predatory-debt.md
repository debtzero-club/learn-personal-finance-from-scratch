...
quiz:
  - q: "Roughly what APR does a typical two-week payday loan carry?"
    options:
      - "About 5%"
      - "About 24%"
      - "Around 400%"
      - "0% — they're free"
    answer: 2
    explain: "A common '$15 per $100 borrowed for two weeks' fee works out to roughly 400% APR. The flat fee sounds small, but annualized it's an enormous rate — far above even a high credit card."
  - q: "Why are payday loans called a 'debt trap'?"
    options:
      - "They're hard to apply for"
      - "They're due in full so fast that many borrowers can't repay and must roll the loan over, paying new fees each time"
      - "They build your credit too quickly"
      - "They have no fees at all"
    answer: 1
    explain: "The full balance plus fee is typically due on your next payday. If you can't cover it and still pay rent, you roll it over for another fee — and again, and again. The product is built around that cycle."
  - q: "What's a warning sign of a predatory loan?"
    options:
      - "It checks carefully whether you can afford to repay"
      - "A flat fee that hides a triple-digit APR, little or no check that you can repay, and demands for access to your bank account or car title"
      - "It reports your on-time payments to build credit"
      - "It has a clearly stated, low APR"
    answer: 1
    explain: "Predatory lenders profit when you *can't* easily repay, so they skip the affordability check, bury the true rate behind a flat fee, and secure access to your money or your car. Those are the red flags."
  - q: "What should you try before a payday or title loan?"
    options:
      - "Nothing — they're the only option"
      - "Alternatives: a payment plan with the biller, a small credit-union loan, help from a local assistance program, or asking family — almost anything is cheaper"
      - "A second payday loan to cover the first"
      - "Ignoring the bill entirely"
    answer: 1
    explain: "Because the APR is so extreme, nearly every alternative costs less: asking the biller for a payment plan, a small loan from a credit union (some offer payday alternatives), local emergency-assistance programs, or even a credit card cash advance (expensive, but far below 400%)."
sources:
