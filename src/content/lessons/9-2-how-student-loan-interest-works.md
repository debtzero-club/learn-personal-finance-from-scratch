...
phase: 9
order: 2
title: "How student loan interest works (and capitalization)"
...
quiz:
  - q: "How does interest accrue on a federal student loan?"
    options:
      - "Once a year, on your loan's anniversary"
      - "Daily simple interest — balance × (rate ÷ 365) is added every single day"
      - "Only after you miss a payment"
      - "It compounds every minute"
    answer: 1
    explain: "Federal student loans accrue simple interest daily: your balance times the rate, divided by 365, every day. On $27,000 at about 6.5%, that's roughly $4.81 a day — around $146 a month — whether or not you're paying yet."
  - q: "What is capitalization?"
    options:
      - "Paying your loan off early"
      - "Unpaid interest being added to your principal, so future interest accrues on the bigger balance"
      - "The government forgiving your interest"
      - "Writing your loan amount in capital letters"
    answer: 1
    explain: "Capitalization is the moment the pile of unpaid interest stops sitting off to the side and joins the principal. From then on, daily interest is calculated on the bigger base — interest accruing on interest. It's the Phase 6 snowball, pointed against you."
  - q: "In the worked example, what does one 12-month unpaid deferment do to a $27,000 loan at ~6.5%?"
    options:
      - "Nothing — deferments are free"
      - "It adds $1,755 of interest, which capitalizes into a $28,755 principal that costs about $114 more interest every year after"
      - "It cuts the balance in half"
      - "It doubles the interest rate"
    answer: 1
    explain: "A year of unpaid interest at ~6.5% on $27,000 is $1,755. When the deferment ends, that interest capitalizes: the new principal is $28,755, and the yearly interest rises from $1,755 to about $1,869 — roughly $114 more, every year, from one unpaid year."
  - q: "When does capitalization mainly happen on federal loans today?"
    options:
      - "Every month, automatically"
      - "When you exit a deferment on an unsubsidized loan, or when you consolidate"
      - "Whenever you make a payment"
      - "It was abolished entirely"
    answer: 1
    explain: "Rule changes in 2023 eliminated most capitalization events, but two big ones remain: ending a deferment on an unsubsidized loan, and consolidating (outstanding interest joins the new principal). The deferment case is exactly the one new grads hit."
sources:
  - label: "Federal Student Aid — Student loan interest rates and capitalization"
    url: "https://studentaid.gov/understand-aid/types/loans/interest-rates"
  - label: "Federal Student Aid — Interest rates for new Direct Loans"
...
| | Before | After a 12-month unpaid deferment |
| --- | ---: | ---: |
