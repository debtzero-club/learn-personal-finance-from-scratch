...
phase: 14
order: 3
title: "Index funds: the boring answer that works"
summary: "An index is a published list measuring a slice of the market — like the S&P 500 — and an index fund simply buys the whole list, giving you a tiny piece of hundreds of companies in one purchase (diversification) at a very low yearly cost (expense ratio)."
status: complete
mechanics: false
lastReviewed: "2026-06-11"
doIt: "Memorize the two-filter checklist — (1) tracks a broad index, (2) low expense ratio — and say what each filter buys you: hundreds of companies in one purchase, and almost nothing skimmed off the top. That checklist is the whole shopping list when lesson 14.5 walks through a first purchase."
keepThis: "An index fund buys the whole published list — the S&P 500 is 500 of the biggest US companies; 'total market' funds hold nearly every public US company — so one purchase spreads you across hundreds of companies (diversification) for a tiny yearly fee (expense ratio). Boring is the feature: consistently beating the market is rare enough that not trying is the answer that works."
quiz:
  - q: "What is a market index, like the S&P 500?"
    options:
      - "A company you can buy shares of directly"
      - "A published list that measures a slice of the market — the S&P 500 tracks 500 of the biggest US companies"
      - "A government savings program"
      - "A type of bank account"
    answer: 1
    explain: "An index is a measuring stick: a maintained list of companies whose combined performance summarizes a slice of the market. The S&P 500 covers 500 of the biggest US companies; 'total US market' indexes stretch to nearly every public US company. When the news says 'the market was up today,' an index is what they're quoting."
  - q: "What does an index fund actually do?"
    options:
      - "Hires experts to pick the few stocks most likely to win"
      - "Buys everything on the index's list, so one purchase makes you a part-owner of hundreds of companies at once"
      - "Guarantees a fixed interest rate like a savings account"
      - "Invests only in the single best company each year"
    answer: 1
    explain: "An index fund doesn't pick winners — it buys the whole list it tracks. One purchase of a total-market index fund makes you a tiny part-owner of nearly every public US company simultaneously. No judgment calls, no star manager — which is exactly why it costs so little to run."
  - q: "Why does diversification protect you?"
    options:
      - "It guarantees the fund can never lose value"
      - "With your money spread across hundreds of companies, one company's collapse barely dents you — no single bet can sink you"
      - "It doubles your returns automatically"
      - "It lets you skip paying the expense ratio"
    answer: 1
    explain: "Diversification means not riding on any one company. If one of 500 holdings fails, you've lost a sliver, not your savings. The whole market can still swing down together — diversification doesn't erase market risk (lesson 14.2) — but it removes the single-company disaster entirely."
  - q: "A fund charging a 1% expense ratio employs people trying to beat the market; an index fund charges 0.05%. Why do many long-term investors take the cheap one?"
    options:
      - "Expensive funds are illegal for beginners"
      - "Consistently beating the market is rare even for professionals, while the 1% fee is skimmed every single year regardless — so the low-cost fund usually wins over time"
      - "The 0.05% fund pays you the difference in cash"
      - "Index funds are insured against losses"
    answer: 1
    explain: "The fee is certain; the outperformance isn't. Most professional stock-pickers fail to beat their index consistently over long stretches, but their ~1% fee comes out every year either way — 20x the skim of a typical index fund, compounding against you for decades. Not playing that game is the boring answer that works."
sources:
  - label: "Investor.gov (SEC) — Mutual funds and exchange-traded funds (ETFs)"
