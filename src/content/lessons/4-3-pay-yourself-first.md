...
phase: 4
order: 3
title: "Pay yourself first — the one habit that does the work"
summary: "Save before you spend, not from whatever's left over. Moving your savings on payday — before the money has a chance to disappear — is the single habit that builds wealth."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "Pick the amount you want to save each payday (even $25 to start). Set it to move to savings the day your paycheck lands — before you spend on anything else."
keepThis: "Save first, spend the rest. Money that leaves on payday is money that never gets a chance to disappear."
quiz:
  - q: "What does 'pay yourself first' actually mean?"
    options:
      - "Buy yourself something nice before paying bills"
      - "Move money to savings on payday, before you spend on anything else"
      - "Pay your credit card before your rent"
    answer: 1
    explain: "Paying yourself first means your savings comes off the top, on payday — treated like a bill to your future self, not an afterthought."
  - q: "Why does saving 'from what's left over' usually fail?"
    options:
      - "There's almost never anything left over — spending expands to fill the account"
      - "Leftover money earns no interest"
      - "Banks don't allow it"
    answer: 0
    explain: "If saving is last in line, it loses. Money in your checking account tends to get spent. Saving first removes it from temptation before that happens."
  - q: "On the $48k anchor budget, roughly how much is the 20% saving-and-debt bucket each month?"
    options:
      - "About $170"
      - "About $679"
      - "About $1,700"
    answer: 1
    explain: "20% of the ~$3,396 monthly take-home is about $679 — the amount to pay yourself first each month, before wants and extras."
sources:
