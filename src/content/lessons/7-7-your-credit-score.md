...
phase: 7
order: 7
title: "Your credit score: what actually moves it"
...
quiz:
  - q: "Which factor carries the most weight in a credit score?"
    options:
      - "How much money is in your checking account"
      - "Payment history — whether you pay on time"
      - "Your salary"
      - "How many times you check your own score"
    answer: 1
    explain: "Payment history is the single biggest factor. A consistent record of on-time payments is the strongest signal that you repay what you borrow."
  - q: "What is credit utilization?"
    options:
      - "How often you use your card per week"
      - "The share of your available credit you're using — your balance divided by your limit"
      - "Your total income"
      - "The number of cards you own"
    answer: 1
    explain: "Utilization is your balance as a percentage of your credit limit. Using $300 of a $1,000 limit is 30% utilization. Lower is generally better; keeping it well under 30% helps."
  - q: "Does checking your own credit score hurt it?"
    options:
      - "Yes, every time"
      - "No — checking your own score is a 'soft inquiry' that doesn't affect it"
      - "Only on weekends"
      - "It deletes your history"
    answer: 1
    explain: "Checking your own score is a soft inquiry and has no effect. A 'hard inquiry' happens when a lender checks because you applied for credit, and that can ding your score slightly and temporarily."
  - q: "Which of these is a factual way the score is built?"
    options:
      - "It's random"
      - "It weighs payment history, utilization, length of credit history, credit mix, and recent inquiries"
      - "It only looks at your age"
      - "It's set by your employer"
    answer: 1
    explain: "Scoring models combine several factors — payment history and utilization weigh most, followed by how long you've had credit, the mix of credit types, and how much new credit you've recently sought."
sources:
