...
quiz:
  - q: "What is a secured credit card?"
    options:
      ...
      - "A card you back with a refundable cash deposit, which becomes your credit limit"
      - "A debit card"
      - "A card only for emergencies"
    answer: 1
    explain: "A secured card requires a refundable deposit (say $200) that becomes your limit. You use it like a normal card and pay it off; the deposit lowers the lender's risk, making it a common starter for no-credit borrowers."
  - q: "How can becoming an 'authorized user' help build credit?"
    options:
      - "It can't"
      - "You're added to someone else's well-managed card, and its positive history can appear on your report"
      - "It gives you their salary"
      - "It erases your old debt"
    answer: 1
    explain: "If a trusted family member adds you as an authorized user on a card they pay on time, that account's good history can show up on your credit report, giving you a foundation you didn't have before."
  - q: "Once you have a starter account, what actually builds the credit?"
    options:
      - "Spending as much as possible"
      - "Paying on time and keeping balances low, month after month"
      - "Closing it quickly"
      - "Applying for ten more cards"
    answer: 1
    explain: "The starter tool just gets you in the door. What builds the score is the same two habits from the last lesson — consistent on-time payments and low utilization — repeated over time."
  - q: "Roughly how fast can you build solid credit?"
    options:
      - "Overnight"
      - "It takes time — months of on-time payments, with history strengthening over years"
      - "In one purchase"
      - "It's impossible without a high salary"
    answer: 1
    explain: "There's no instant version. A few months of on-time payments starts a record, and length of history keeps helping for years. Consistency, not speed, is the whole game."
sources:
