...
phase: 14
order: 4
title: "Retirement accounts recap (401k, IRA, Roth)"
summary: "The account and the investment are two different things: a 401(k) or IRA is the tax-advantaged container, and the index fund from 14.3 is what goes inside it — recapping the Phase 10 toolkit and the order most people fill it: match first, then a Roth IRA, then more 401(k)."
status: complete
mechanics: false
lastReviewed: "2026-06-11"
doIt: "Open your 401(k) portal and look at one thing you've probably never checked: not how much goes in, but what it's invested IN. Find the fund names, look for the word 'index' and each fund's expense ratio, and apply the 14.3 checklist. Five minutes, and the container-vs-contents idea becomes real money you own."
keepThis: "The account is the container (401(k), IRA — with Roth or traditional tax timing); the investment is the contents (the broad index fund from 14.3). One without the other is half a plan. The order most people follow: capture the full match, then a Roth IRA, then more 401(k) — lesson 11.4 keeps the current year's contribution limits."
quiz:
  - q: "What's the difference between the account and the investment?"
    options:
      - "Nothing — they're two words for the same thing"
      - "The account (401(k), IRA) is the tax-advantaged container; the investment (like an index fund) is what actually grows inside it"
      - "Accounts grow money; investments just hold it"
      - "Investments are only allowed outside of accounts"
    answer: 1
    explain: "A 401(k) or IRA is a wrapper that changes how money inside is taxed — it isn't itself an investment. What the money grows in is the contents you choose, like the broad index fund from lesson 14.3. Money sitting in a retirement account but never invested in anything is a surprisingly common and expensive mistake."
  - q: "How do Roth and traditional differ?"
    options:
      - "Roth is for the rich; traditional is for everyone else"
      - "It's about when the tax hits: traditional skips tax now and pays it in retirement; Roth pays tax now and withdrawals come out tax-free later"
      - "Roth accounts can't hold index funds"
      - "Traditional accounts have no tax advantage at all"
    answer: 1
    explain: "Same containers, different tax timing (lesson 10.3). Traditional contributions reduce this year's taxable income but get taxed on the way out; Roth contributions are taxed now, and qualified withdrawals — including all the decades of growth — come out tax-free. For someone early-career in a low bracket, paying the low tax now is why the Roth choice gets so much attention."
  - q: "Why does the usual filling order start with the 401(k) match, before any IRA?"
    options:
      - "Because IRAs are illegal until age 30"
      - "Because the match is an instant 100% return on those dollars — free money no investment can reliably beat"
      - "Because 401(k)s have no contribution limits"
      - "Because employers require it"
    answer: 1
    explain: "The anchor's 4% match adds $1,920 a year of employer money on top of their own (lesson 10.2) — a guaranteed doubling of those contributions before any market growth. Nothing else in investing offers that, so capturing the full match generally comes first; then a Roth IRA; then more 401(k) as the budget allows."
  - q: "Where do the actual contribution-limit dollar amounts for these accounts live in this course?"
    options:
      - "This lesson lists them all permanently"
      - "Lesson 11.4 carries the current year's limits — they change over time, so the recap points there instead of reprinting numbers that will age"
      - "There are no limits on retirement accounts"
      - "Only your employer knows the limits"
    answer: 1
    explain: "Contribution ceilings are adjusted over time, so this recap keeps the durable shape — container vs contents, Roth vs traditional, match → Roth IRA → more 401(k) — and lesson 11.4 holds the year-specific figures, where they're reviewed annually."
sources:
  - label: "Investor.gov (SEC) — Employer-sponsored retirement plans"
    url: "https://www.investor.gov/introduction-investing/retirement-plans/employer-sponsored-plans"
  - label: "Investor.gov (SEC) — Individual retirement accounts (IRAs)"
...
1. **Capture the full 401(k) match.** Free money, instant 100% return on those dollars (lesson 10.2).
2. **Then a Roth IRA.** Early-career usually means a low tax bracket — paying today's low rate to make all future growth tax-free is the logic from lesson 10.3.
3. **Then back to the 401(k) for more**, as the budget grows.
