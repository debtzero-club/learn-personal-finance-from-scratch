...
phase: 1
order: 6
title: "Your money snapshot: where am I right now?"
summary: "Before you can improve anything, you need a clear picture. A 10-minute snapshot of what you own, what you owe, and what flows in and out."
status: complete
mechanics: false
lastReviewed: "2026-06-07"
doIt: "Spend 10 minutes writing down four numbers: (1) total cash you have, (2) total debt you owe, (3) money in per month, (4) money out per month. That's your snapshot. Save it."
keepThis: "Net worth = what you own minus what you owe. It can be negative when you're starting out — that's normal. The number's only job is to move the right direction over time."
quiz:
  - q: "How do you calculate net worth?"
    options:
      - "Income minus expenses"
      - "What you own minus what you owe"
      - "Whatever's in your checking account"
    answer: 1
    explain: "Net worth is assets (cash, savings, investments) minus debts (cards, loans). It's a snapshot of your whole position, not just one account."
  - q: "Your net worth is negative right now. What does that mean?"
    options:
      - "You've failed at money"
      - "It's common early on (hello, student loans) — the goal is the trend, not today's number"
    answer: 1
    explain: "Lots of people in their early 20s have negative net worth because of student loans. Totally normal. You're tracking direction, not judging the starting point."
sources:
  - label: "CFPB — Assess your financial well-being"
