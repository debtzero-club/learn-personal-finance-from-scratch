...
phase: 12
order: 3
title: "Renters & auto insurance — cheap protection you skip"
...
quiz:
  - q: "A pipe bursts and ruins your laptop, clothes, and furniture. Who pays?"
    options:
      - "The landlord's insurance — it covers everything inside the building"
      - "Your renters insurance, if you have it — the landlord's policy covers the building, not your belongings"
      - "The city, since it's a plumbing issue"
      - "Nobody — belongings can't be insured"
    answer: 1
    explain: "The landlord's policy protects the landlord's building. Your belongings are yours to protect — that's exactly what renters insurance covers (along with your liability if you accidentally injure someone or damage the property)."
  - q: "Which part of auto insurance is legally required in almost every state?"
    options:
      - "Collision — coverage for your own car"
      - "Comprehensive — theft and weather damage"
      - "Liability — coverage for the harm you cause to other people and their property"
      - "Roadside assistance"
    answer: 2
    explain: "States require liability coverage because it protects everyone else on the road from you. Collision and comprehensive — the parts that pay for your own car — are optional by law, though a lender will require them while you're financing."
  - q: "You're financing a car. Why does the lender care whether you carry coverage on the car itself?"
    options:
      - "They don't — insurance is entirely your business"
      - "Until the loan is paid, the car is the loan's collateral — if it's totaled uninsured, the lender's security vanishes (they can even force-place a policy and bill you)"
      - "Lenders earn commission on insurance"
      - "It's required by the dealer, not the lender"
    answer: 1
    explain: "Remember secured debt from lesson 8.1: the car backs the loan. Lenders protect that collateral by requiring coverage — and the CFPB warns that if your insurance lapses, the lender can buy 'force-placed' insurance that protects them, not you, at your expense."
  - q: "Choosing a higher deductible on a renters or auto policy generally does what?"
    options:
      - "Raises your premium"
      - "Lowers your premium — you keep more of the small risk, so the known cost shrinks"
      - "Changes nothing"
      - "Cancels your liability coverage"
    answer: 1
    explain: "Same seesaw as the health plan in 12.2: the more of the first dollars you agree to cover yourself, the less the insurer charges you per month. Pick a deductible your emergency fund could cover without flinching."
sources:
