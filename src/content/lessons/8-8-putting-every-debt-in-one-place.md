...
quiz:
  - q: "What's the first step in building a debt payoff plan?"
    options:
      - "Take out a new loan"
      - "Get every debt into one view — name, balance, APR, and minimum payment"
      - "Check your credit score daily"
      - "Pay whichever bill is loudest"
    answer: 1
    explain: "You can't make a plan for debts you can't see. Listing every one — with its balance, rate, and minimum — in a single place is the foundation everything else builds on."
  - q: "Which four pieces of information should your payoff picture show for each debt?"
    options:
      - "Name, balance, APR, and minimum payment"
      - "Name, color, mood, and zip code"
      - "Only the total you owe"
      - "Just the interest rate"
    answer: 0
    explain: "Name (which debt), balance (how much), APR (how expensive), and minimum (what you must pay) are the four numbers that let you choose an order and track progress. The APR column is what tells avalanche where to strike."
  - q: "Once your debts are all in one place, how do you pick what to pay first?"
    options:
      - "Randomly"
      - "Use avalanche (highest APR) or snowball (smallest balance) — the picture makes the order obvious"
      - "Always the biggest balance"
      - "Whichever you forget about"
    answer: 1
    explain: "With balances and rates side by side, the avalanche order (sort by APR) and the snowball order (sort by balance) are right there to read. The picture turns the strategy from lesson 8.6 into a concrete first target."
  - q: "Why does seeing all your debts in one view help so much?"
    options:
      - "It makes the debt disappear"
      - "It replaces vague dread with a concrete, ordered, trackable plan — and lets you watch progress"
      - "It lowers your interest rates automatically"
      - "It has no real effect"
    answer: 1
    explain: "Scattered debts feel hopeless because you can't grasp them all at once. One page makes the total real, the order clear, and progress visible — which is what keeps people going."
sources:
  - label: "CFPB — How to reduce your debt"
    url: "https://www.consumerfinance.gov/about-us/blog/how-reduce-your-debt/"
  - label: "CFPB — Debt: getting and staying out of it"
...
1. **Name** — which debt it is (Visa, auto loan, store card).
2. **Balance** — how much you currently owe on it.
3. **APR** — its interest rate, so you can see how expensive it is.
4. **Minimum payment** — the least you must pay each month to stay current.
