...
phase: 4
order: 7
title: "Budgeting when your income is irregular"
summary: "Tips, gig work, freelancing, commission — when your pay jumps around, budget off your lowest expected month and let the good months build a buffer instead of new spending."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "Look back at your last several months of income and find your lowest realistic month. Build your everyday budget on that floor number, not your average — and route the extra from good months into savings."
keepThis: "Budget off your lowest expected month, not your average. The surplus from good months becomes the buffer that carries the lean ones."
quiz:
  - q: "When your income is irregular, what number should your everyday budget be based on?"
    options:
      - "Your best month — aim high"
      - "Your average month"
      - "Your lowest realistic month — the floor"
    answer: 2
    explain: "Budgeting off the floor means even a lean month covers your needs. Averages get you into trouble, because half your months come in below the average."
  - q: "What should you do with the extra money in a good month?"
    options:
      - "Increase your spending to match"
      - "Bank it as a buffer to smooth out the lean months"
      - "Assume every month will now be that good"
    answer: 1
    explain: "Good-month surplus is the whole engine of irregular-income budgeting: it fills a buffer that pays you a steadier 'salary' through the slow stretches."
  - q: "You average $3,000/month but your slow months dip to $2,200. What's the smart move?"
    options:
      - "Budget your needs around $2,200 and save the difference in better months"
      - "Budget around $3,000 and borrow when you fall short"
      - "Quit and find a salaried job"
    answer: 0
    explain: "Base your needs on the $2,200 floor so a slow month never sinks you, and let the ~$800 of good-month surplus build the buffer that steadies everything."
sources:
  - label: "CFPB — Creating a cash flow budget (tool)"
...
| Month type | Income | Spend to floor | Into buffer (after wants/saving) |
|------------|--------|----------------|-------------------------------|
