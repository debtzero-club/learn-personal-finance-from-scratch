...
phase: 2
order: 3
title: "FICA, Social Security & Medicare — what's actually taken out"
summary: "The 7.65% that leaves every paycheck no matter what — what it is, what it buys, and why most first-jobbers never hit its ceiling."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "On your next pay stub, find the two FICA lines. They'll be labeled something like 'Social Security' (or 'OASDI') and 'Medicare.' Add them — that's your 7.65%, and it should be about 7.65% of your gross for the period."
keepThis: "FICA is a flat 7.65% (6.2% Social Security + 1.45% Medicare) on your wages. On $48,000 that's about $3,672 a year, and you can't opt out — but it funds your future Social Security and Medicare."
quiz:
  - q: "What is FICA?"
    options:
      - "A federal income-tax bracket"
      - "Payroll tax for Social Security and Medicare, taken from every paycheck"
      - "An optional retirement plan"
    answer: 1
    explain: "FICA = Federal Insurance Contributions Act. It's the 7.65% that funds Social Security and Medicare, withheld automatically from your wages."
  - q: "What's the total FICA rate for most employees?"
    options:
      - "1.45%"
      - "6.2%"
      - "7.65%"
    answer: 2
    explain: "6.2% for Social Security plus 1.45% for Medicare equals 7.65% on your wages."
  - q: "On a $48,000 salary, roughly how much FICA comes out in a year?"
    options:
      - "About $720"
      - "About $3,672"
      - "About $7,344"
    answer: 1
    explain: "$48,000 × 7.65% ≈ $3,672 ($2,976 Social Security + $696 Medicare). Your employer quietly pays a matching amount on top."
  - q: "There's a cap on Social Security tax. For 2026 it stops after how much in wages?"
    options:
      - "$48,000"
      - "$184,500"
      - "There is no cap"
    answer: 1
    explain: "Social Security tax (the 6.2% part) only applies up to the wage base — $184,500 in 2026. Most first-jobbers never reach it. Medicare's 1.45% has no cap."
sources:
