...
phase: 8
order: 2
title: "How a loan actually works: principal, interest, term"
...
quiz:
  - q: "What are the three numbers that define any installment loan?"
    options:
      - "Balance, late fee, and credit score"
      - "Principal (amount borrowed), interest rate (APR), and term (length)"
      - "Deposit, withdrawal, and overdraft"
      - "Minimum, maximum, and average"
    answer: 1
    explain: "Principal is what you borrow, the rate is the yearly cost of borrowing it, and the term is how long you have to pay it back. Those three numbers fully determine your fixed monthly payment."
  - q: "On the $20,000 auto loan at 7% APR over 60 months, what's the monthly payment?"
    options:
      - "$333.33 — just the principal split evenly"
      - "$396.02"
      - "$1,400"
      - "$200"
    answer: 1
    explain: "The calculator pins it at $396.02. That's higher than $20,000 ÷ 60 ($333.33) precisely because interest is baked into every payment."
  - q: "How much total interest does that loan cost over the full 60 months?"
    options:
      - "$0 — auto loans are interest-free"
      - "About $400"
      - "$3,761.48"
      - "$20,000"
    answer: 2
    explain: "You pay back $23,761.48 total on a $20,000 loan — $3,761.48 of it is interest, about 19% on top of the principal."
  - q: "If you keep the same loan but shorten the term (say 36 months instead of 60), what happens?"
    options:
      - "The monthly payment drops and you pay more interest"
      - "The monthly payment rises but you pay much less total interest"
      - "Nothing changes"
      - "The interest rate automatically doubles"
    answer: 1
    explain: "A shorter term means bigger monthly payments, but the loan is gone sooner, so interest has far less time to accumulate. Term is a powerful lever — try it in the calculator."
sources:
