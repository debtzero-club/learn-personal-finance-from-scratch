...
quiz:
  - q: "What's the first thing to do when a debt collector contacts you?"
    options:
      - "Immediately pay whatever they ask"
      - "Don't admit to or pay anything yet — request written validation of the debt within 30 days"
      - "Hang up and ignore it forever"
      - "Give them your full bank login"
    answer: 1
    explain: "You have the right to a written validation notice proving the debt is yours and the amount is correct. Requesting it within 30 days pauses collection until they provide it — and protects you from paying a debt that isn't yours or is wrong."
  - q: "Under federal law (the FDCPA), what can a collector NOT do?"
    options:
      - "Contact you about a debt at all"
      - "Harass or threaten you, call at unreasonable hours, or lie about what you owe"
      - "Ever send you a letter"
      - "Accept a payment plan"
    answer: 1
    explain: "The Fair Debt Collection Practices Act bars harassment, threats, calls at unreasonable times (generally before 8am or after 9pm), and false statements. Collecting a valid debt is allowed; abusing you to do it is not."
  - q: "How do you stop a collector from contacting you?"
    options:
      - "You can't — they can call forever"
      - "Send a written request to stop contact; after that, they may only contact you for specific legal reasons"
      - "Change your name"
      - "Pay double"
    answer: 1
    explain: "A written 'cease contact' request legally limits how a collector can reach you. It doesn't erase the debt, but it stops the calls — they can then only notify you of specific actions like a lawsuit."
  - q: "Why request debt validation before paying?"
    options:
      - "To delay forever"
      - "Because the debt might not be yours, might be the wrong amount, or might be too old — validation forces proof before you pay"
      - "Because paying is never allowed"
      - "There's no reason to"
    answer: 1
    explain: "Collections debts are bought and sold, and errors are common — wrong amounts, wrong person, debts past the legal time limit. Validation makes the collector prove it's a real, correct, collectible debt before a dollar leaves your account."
sources:
