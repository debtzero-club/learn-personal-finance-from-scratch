...
phase: 6
order: 1
title: "Interest, the simplest version: money that grows, or costs, over time"
summary: "Interest is the price of using money over time — you earn it on savings and you pay it on debt — and it's the same idea sitting under every account, card, and loan you'll ever touch."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "Open your bank app and find one interest rate — the APY on your savings, or the APR on a card. Just notice it's there and which side you're on: earning it, or paying it."
keepThis: "Interest is rent on money. On savings, the bank pays you rent for parking your cash there. On debt, you pay rent for using someone else's money. Same idea, two directions."
quiz:
  - q: "What is interest, in plain terms?"
    options:
      - "A one-time fee the bank charges to open an account"
      - "The price of using money over time — earned on savings, paid on debt"
      - "A tax the government takes from your paycheck"
      - "The same thing as your account balance"
    answer: 1
    explain: "Interest is rent on money. You earn it when your money sits in a savings account; you pay it when you borrow. It always relates to an amount and a stretch of time."
  - q: "You keep $1,000 in a savings account that pays 4% a year. Roughly how much interest do you earn in a year?"
    options:
      - "$4"
      - "$40"
      - "$400"
      - "Nothing — savings don't pay interest"
    answer: 1
    explain: "4% of $1,000 is $40. The rate is a percentage of the amount, measured over a year — so $1,000 × 0.04 = $40."
  - q: "When are you on the paying side of interest?"
    options:
      - "When money sits in your savings account"
      - "When you carry a balance on a loan or credit card"
      - "Only when you file your taxes"
      - "Never — interest is always free money"
    answer: 1
    explain: "Borrowing flips it around: now you're renting someone else's money, so you pay the interest. A card balance, a car loan, and a student loan are all the paying side."
  - q: "What two things does any interest rate depend on?"
    options:
      - "Your age and your zip code"
      - "The amount of money and the length of time"
      - "The bank's name and its logo color"
      - "Only the amount — time doesn't matter"
    answer: 1
    explain: "Interest is always 'this much, for this long.' Change the amount or the time and the interest changes. That time piece is what makes the next few lessons so powerful."
sources:
  - label: "CFPB — What is a credit card interest rate? What does APR mean?"
