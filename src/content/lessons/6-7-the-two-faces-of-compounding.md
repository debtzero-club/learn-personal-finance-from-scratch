...
phase: 6
order: 7
title: "The two faces of compounding: friend when saving, enemy in debt"
...
quiz:
  - q: "What does it mean that compounding has 'two faces'?"
    options:
      - "There are two completely different formulas"
      - "The same engine grows your savings AND grows your debt — friend or enemy depending on which side you're on"
      - "It only works on weekends"
      - "It only applies to investing"
    answer: 1
    explain: "Compounding is one mechanism: interest earning interest. Aimed at your savings it's a snowball in your favor; aimed at a balance you owe, the same snowball works against you."
  - q: "Why is high-rate debt the 'enemy face' at its worst?"
    options:
      - "Because the rate is usually higher than savings rates, so the snowball is bigger and faster"
      - "Because debt never charges interest"
      - "Because savings always grow faster than debt"
      - "Because debt rates are always 0%"
    answer: 0
    explain: "Card APRs (often 20%+) dwarf typical savings APYs (a few percent). The same compounding engine runs much hotter on the debt, so an unpaid balance snowballs far faster than savings ever could."
  - q: "Why is paying off high-rate debt often called a guaranteed 'return'?"
    options:
      - "Because the government pays you to do it"
      - "Because every dollar of high-rate debt you erase stops that costly interest from compounding against you"
      - "Because it raises your salary"
      - "It isn't — paying off debt does nothing"
    answer: 1
    explain: "Killing a 24% debt is like locking in a 24% 'return,' because you've stopped that interest from piling up. No savings account pays that, which is why high-rate debt usually comes first."
  - q: "What's the one-sentence goal this whole phase points to?"
    options:
      - "Earn the highest possible investment returns"
      - "Get compounding working for you, and stop it from working against you"
      - "Avoid all interest forever"
      - "Always pay only the minimum"
    answer: 1
