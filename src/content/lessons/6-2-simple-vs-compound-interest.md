...
phase: 6
order: 2
title: "Simple vs. compound interest — the difference that changes your life"
...
quiz:
  - q: "What's the core difference between simple and compound interest?"
    options:
      - "Simple is for banks, compound is for credit cards"
    ...
    answer: 1
    explain: "With simple interest, only your starting amount ever earns. With compound interest, the interest you've already earned starts earning too — interest on interest. That's the whole difference."
  - q: "$1,000 earns 10% a year. With SIMPLE interest, how much do you have after 2 years?"
    options:
      - "$1,100"
      - "$1,200"
      - "$1,210"
      - "$2,000"
    answer: 1
    explain: "Simple interest pays a flat $100 each year on the original $1,000: $1,000 → $1,100 → $1,200. The interest never starts earning its own interest."
  - q: "Same $1,000 at 10%, but COMPOUND. After 2 years?"
    options:
      - "$1,200"
      - "$1,210"
      - "$1,100"
      - "$2,000"
    answer: 1
    explain: "Year 1 adds $100 ($1,100). Year 2 earns 10% on the new $1,100 — that's $110 — landing at $1,210. The extra $10 is interest earning interest. Small now, but it grows every year."
  - q: "Why does the gap between simple and compound get bigger over time?"
    options:
      - "Because rates rise automatically"
      - "Because each year's interest joins the pile and earns interest too, so the compounding pile keeps pulling ahead"
      - "Because simple interest stops after a year"
      - "It doesn't — the gap stays the same"
    answer: 1
