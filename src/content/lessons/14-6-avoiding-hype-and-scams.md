...
phase: 14
order: 6
title: "Avoiding hype, scams, and \"get rich quick\""
...
quiz:
  - q: "Why do crypto, meme stocks, options, and day trading show up in this course only as risk categories?"
    options:
      - "Because they're secretly the best investments"
      - "Because they're where beginners most often get burned — extreme volatility, hype cycles, leverage and complexity, and costs stacked against you — not because naming them teaches you to use them"
      - "Because they're all illegal in the US"
      - "Because they require a license to discuss"
    answer: 1
    explain: "Each one transfers money most reliably away from inexperienced people: crypto can swing violently on pure sentiment, meme stocks run on hype cycles that end abruptly, options add leverage and complexity that can wipe out a position fast, and day trading stacks costs and odds so steeply that most individuals lose money at it. This course names them so you recognize them — not so you try them."
  - q: "A stranger DMs you about an investing group with 'guaranteed 2% weekly returns.' What's the math-based tell?"
    options:
      - "2% a week is reasonable — banks pay close to that"
      - "2% a week compounds to nearly triple your money every year — wildly beyond the ~10% historical long-run stock average — and 'guaranteed' plus 'high return' don't coexist in real markets"
      - "The only problem is that they used a DM"
      - "There's no tell; you'd have to try it to know"
    answer: 1
    explain: "Run lesson 14.1's numbers: the strongest mainstream asset class has averaged just over 10% a year over the long run — with real risk and wild swings, never guaranteed. Someone claiming guaranteed returns many times that isn't outperforming the market; they're describing a scam. The SEC lists 'guaranteed high returns' as a classic fraud signature."
  - q: "Which of these is a scam red flag from the FTC and SEC playbook?"
    options:
      - "Being asked to take your time and read documents carefully"
      - "Pressure to act RIGHT NOW, payment demanded in crypto or gift cards, or an influencer promising 'free money' to their followers"
      - "A fund disclosing its expense ratio up front"
      - "An account that takes a day to open"
    answer: 1
    explain: "Urgency exists to stop you from thinking or checking — real opportunities survive a day of thought. Crypto and gift cards are demanded because those payments can't be reversed or traced. And 'free money' hype from influencers (who are often paid promoters, or running the exit themselves) is FOMO mechanics, not finance."
  - q: "What's the 'boring defense' this lesson lands on?"
    options:
      - "Never investing in anything, ever"
      - "If it sounds too good to be true, it is — real investing is the decades-boring index-fund snowball from 14.3, and anything promising to skip those decades is selling the skip, not the wealth"
      - "Only investing in whatever is trending that week"
      - "Moving fast so scammers can't keep up"
    answer: 1
    explain: "Every get-rich-quick pitch is selling the same product: skipping the time that compounding requires. But time is the engine (lesson 14.1) — remove it and there's no math left, only a story. The plan you built in 14.5 is immune to hype precisely because it never needed a miracle."
sources:
  - label: "Investor.gov (SEC) — Types of investment fraud"
    url: "https://www.investor.gov/protect-your-investments/fraud/types-fraud"
  - label: "FTC — Consumer advice on scams"
