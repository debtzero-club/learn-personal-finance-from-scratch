...
phase: 14
order: 5
title: "Your first investment, step by step"
summary: "The five steps first-time investors generally walk through: confirm the prerequisites (match, emergency fund, high-rate debt), pick the container, open an account at a low-cost brokerage using criteria — $0 minimums, no commissions, index funds available — pick a broad index fund, and automate a monthly amount."
status: complete
mechanics: false
lastReviewed: "2026-06-11"
doIt: "Run the prerequisite check from step 1 tonight — three yes/no questions: Is the full 401(k) match captured? Does the emergency fund exist? Is high-rate debt handled or on a plan? Write down the answers. Three yeses means the only thing between you and step 2 is a free evening; any no tells you exactly which earlier lesson to revisit first."
keepThis: "Five steps, in order: (1) prerequisites — match, emergency fund, high-rate debt plan; (2) pick the container (14.4); (3) open an account at a major low-cost brokerage — judge by criteria, not names: $0 account minimums, no commissions on basic trades, index funds available; (4) pick a broad index fund with a low expense ratio (14.3); (5) automate a monthly amount and stop checking daily. Even $25–50 a month counts — the habit is the asset."
quiz:
  - q: "What are the three prerequisites that generally come before a first investment?"
    options:
      - "A finance degree, a large salary, and a market prediction"
      - "The full 401(k) match captured, an emergency fund in place, and high-rate debt handled or on a plan"
      - "A paid advisor, a hot tip, and perfect timing"
      - "There are none — investing always comes first"
    answer: 1
    explain: "Each one outranks investing on pure math: the match is an instant 100% return (lesson 10.2), the emergency fund keeps a surprise bill from forcing you to sell in a down month (lesson 5.2), and high-rate debt compounds against you faster than markets have historically grown for you (lessons 6.7 and 8.6)."
  - q: "How does this course say to choose a brokerage for an IRA?"
    options:
      - "Whichever one a famous influencer recommends"
      - "By criteria, not names: $0 account minimums, no commissions on basic trades, and index funds available"
      - "The one with the most exciting app design"
      - "Always the one your employer uses"
    answer: 1
    explain: "A brokerage account is just the doorway — at any major low-cost brokerage meeting those three criteria, the same broad index fund behaves identically. The course names criteria instead of companies on purpose: the checklist stays true even as the companies change."
  - q: "Why is automating the monthly amount (step 5) treated as part of the investment itself?"
    options:
      - "Automation earns a higher interest rate"
      - "Because steady adding through good months and bad is what the long-run math rewards — and automation removes the monthly decision where hesitation creeps in"
      - "Because manual purchases are charged extra tax"
      - "It isn't — checking daily works better"
    answer: 1
    explain: "Lesson 14.2 showed the expensive move is not starting (and not continuing). Automation makes continuing the default — the same payday trick as lesson 4.4 — so a down month can't talk you out of the plan. The habit, not any single deposit, is the asset."
  - q: "Is $25–50 a month even worth investing?"
    options:
      - "No — investing only matters above $500 a month"
      - "Yes — $50 a month at even a modest 5% builds about $7,764 in ten years, and the habit it builds scales up with every raise"
      - "No — small amounts are charged penalty fees"
      - "Only if you check the balance daily"
    answer: 1
    explain: "Small and steady is the whole strategy: $50/month at a modest 5% is about $7,764 after ten years — $6,000 deposited, $1,764 of growth — and at the long-run historical average it would compound faster still (never guaranteed, lesson 14.1). More importantly, the automated habit is already built when your income grows."
sources:
  - label: "Investor.gov (SEC) — Introduction to investing"
