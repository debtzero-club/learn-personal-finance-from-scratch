...
phase: 7
order: 3
title: "The grace period — how to borrow for free (if you do it right)"
...
quiz:
  - q: "What does the grace period let you do?"
    options:
      - "Skip payments with no consequences"
      - "Borrow for purchases interest-free, as long as you pay the full statement balance by the due date"
      - "Pay only the minimum forever"
      - "Avoid ever paying the card back"
    answer: 1
    explain: "The grace period is the window where purchases haven't started accruing interest yet. Pay your full statement balance by the due date and you ride that free window every month."
  - q: "What happens to your grace period if you carry a balance?"
    options:
      - "Nothing — it stays the same"
      - "You lose it, and interest starts on new purchases from the day you make them"
      - "It doubles in length"
      - "Only the minimum changes"
    answer: 1
    explain: "Once you carry a balance forward instead of paying in full, the grace period vanishes. New purchases start racking up interest immediately, from the purchase date — no free window."
  - q: "In the calculator below, what happens to the interest when you toggle 'paid last statement in full' ON?"
    options:
      - "It goes up"
      - "It drops to $0 — the grace period means no interest on purchases"
      - "It stays the same"
      - "It becomes negative"
    answer: 1
    explain: "Toggle ON = grace works = $0 interest, even on a $5,000 balance. The bucket doesn't leak. Toggle it OFF (you carried a balance) and the same balance starts costing real money — that's the next lesson."
  - q: "Why is paying the FULL statement balance (not the minimum) the key move?"
    options:
      - "The minimum is illegal"
      - "Only paying the full statement balance keeps the grace period alive; paying less loses it"
      - "The minimum pays it off faster"
      - "There's no difference"
    answer: 1
    explain: "The grace period is an all-or-nothing deal on purchases: pay the full statement balance and it's free; pay even a dollar less and you've carried a balance, so you forfeit the free window."
sources:
