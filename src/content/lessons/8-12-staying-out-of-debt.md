...
quiz:
  - q: "What's the most common reason people fall back into debt after paying it off?"
    options:
      - "Banks force them to"
      - "An unplanned expense (a car repair, a medical bill) with no emergency fund to absorb it, so it goes on a card"
      - "Interest rates are illegal"
      - "They paid off too fast"
    answer: 1
    explain: "Without a buffer, the next surprise expense has nowhere to go but a credit card — restarting the cycle. The emergency fund from Phase 5 is the single biggest thing standing between a one-time payoff and a recurring trap."
  - q: "When a debt is finally paid off, what's the smart move with its old payment?"
    options:
      - "Let it become extra spending money automatically"
      - "Redirect it on purpose — into your emergency fund first, then savings or the next goal"
      - "Cancel your bank account"
      - "Borrow more, since you have room now"
    answer: 1
    explain: "That freed-up payment is real money you're already used to living without. Send it somewhere on purpose — fund the emergency buffer, then save — before it silently dissolves into lifestyle creep."
  - q: "How does a budget (Phase 4) help you stay out of debt?"
    options:
      - "It doesn't"
      - "It keeps spending aligned with income, so you're not relying on credit to fill gaps each month"
      - "It raises your credit limit"
      - "It pays your debts for you"
    answer: 1
    explain: "A working budget — like the 50/30/20 starting point from Phase 4 — makes sure your spending fits your take-home pay. When the month balances on its own, you don't need a card to bridge the gap."
  - q: "What's the relationship between an emergency fund and debt?"
    options:
      - "They're unrelated"
      - "The emergency fund absorbs surprise costs that would otherwise become new debt — it's debt prevention"
      - "An emergency fund causes debt"
      - "You should skip the fund and pay debt forever"
    answer: 1
    explain: "An emergency fund is your shock absorber. When the unexpected hits, it pays the bill instead of a credit card — which is exactly why building even a small buffer is part of staying debt-free, not separate from it."
sources:
