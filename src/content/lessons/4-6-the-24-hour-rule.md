...
phase: 4
order: 6
title: "The 24-hour rule and other anti-impulse tricks"
summary: "Impulse buys beat willpower because they're fast. Adding a little friction — a 24-hour wait, an unsaved card, a one-out-one-in rule — lets the urge pass before the money does."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "Pick one anti-impulse trick and set it up today: add a 24-hour wait rule for any non-essential buy over $50, or delete your saved card from your favorite shopping app."
keepThis: "Friction beats willpower. Put a small delay between wanting something and buying it, and most impulse purchases quietly cancel themselves."
quiz:
  - q: "What's the idea behind the 24-hour rule?"
    options:
      - "You can only shop for 24 hours a week"
      - "Wait a day before a non-essential purchase, so the impulse can pass before you spend"
      - "Returns must happen within 24 hours"
    answer: 1
    explain: "Most impulse urges fade fast. A 24-hour wait lets the excitement cool, so you only buy the things you still want the next day."
  - q: "Why does adding 'friction' work better than just trying harder to resist?"
    options:
      - "Friction makes things cost less"
      - "Impulse buys win because they're effortless; slowing them down gives your thinking brain time to catch up"
      - "It doesn't work — willpower is the only real tool"
    answer: 1
    explain: "Impulse purchases are designed to be one-tap easy. A small delay or hurdle interrupts the autopilot, which is far more reliable than raw willpower."
  - q: "If you pause one $80 impulse buy a month, roughly what's that worth in a year?"
    options:
      - "About $80"
      - "About $480"
      - "About $960"
    answer: 2
    explain: "$80 × 12 = $960 a year. And remember opportunity cost from lesson 1.3 — that's $960 that could be in your emergency fund or off a debt instead."
sources:
