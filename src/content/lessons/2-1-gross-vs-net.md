...
summary: "Your salary is the sticker price; your paycheck is what's left after taxes and deductions — and a raise can never shrink your take-home."
status: complete
mechanics: false
lastReviewed: "2026-06-09"
doIt: "Find your most recent paycheck (in your bank app or a pay-stub portal). Write down two numbers: the gross for the period and what actually landed. The gap is what this whole phase explains."
keepThis: "Gross is the promise, net is the paycheck. On a $48,000 salary, your effective federal income-tax rate is about 7.5% even though your top bracket is 12% — and a raise into a higher bracket only taxes the new dollars, never your whole income."
quiz:
  - q: "What's the difference between gross pay and net pay?"
    options:
      - "Gross is monthly, net is yearly"
      - "Gross is before taxes and deductions; net is what actually hits your account"
      - "They're two words for the same thing"
    answer: 1
    explain: "Gross is your salary on paper. Net (take-home) is what's left after taxes and deductions come out — usually noticeably less."
  - q: "On a $48,000 salary, your top tax bracket is 12%. Roughly what share of your gross actually goes to federal income tax?"
    options:
      - "12% — your bracket is your rate on everything"
      - "About 7.5% — your effective rate is lower than your top bracket"
      - "0% — brackets don't apply until you earn more"
    answer: 1
    explain: "Brackets are marginal: the 12% only hits the dollars inside that band, and the standard deduction shields a big chunk. So the effective (average) rate — about $3,580 of $48,000 — is around 7.5%."
  - q: "You get a raise that pushes part of your income into the next tax bracket. What happens to your take-home?"
    options:
      - "It can drop — the higher bracket taxes your whole salary"
      - "It still goes up — only the dollars above the line are taxed at the higher rate"
      - "It stays exactly the same"
    answer: 1
    explain: "This is the #1 tax myth. A higher bracket only applies to the dollars above its threshold. A raise always leaves you with more take-home, never less."
  - q: "Besides taxes, what else can make net smaller than gross?"
    options:
      - "Nothing — it's only taxes"
      - "Deductions like health insurance premiums or a 401(k) contribution"
      - "The bank's monthly fee"
    answer: 1
    explain: "Pre-tax deductions (health insurance, retirement, HSA/FSA) come out too. We cover paychecks line by line in the next lesson."
sources:
