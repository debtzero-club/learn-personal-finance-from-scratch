...
phase: 14
order: 1
title: "Why investing matters (compounding, now working for you)"
summary: "You've met the compounding snowball three times — growing your savings, growing a card balance against you, growing a student loan in deferment. Investing is pointing that same snowball in your favor on purpose, with decades of runway: historically, stocks have averaged just over 10% a year over the long term — a historical average, not a guarantee."
status: complete
mechanics: false
lastReviewed: "2026-06-11"
calculator: compound
doIt: "In the calculator below, push the years from 10 to 40 and watch what happens to the interest band. That stretch — not the rate, not the deposit — is the case for starting young. Note the ending number; that's what 'decades of runway' looks like."
keepThis: "Same snowball, finally pointed your way: $1,000 + $100/month at a modest 5% grows to $17,175.26 in 10 years. Historically, stocks have averaged just over 10% a year over the long term — but that's a historical average, not a guarantee; real years swing wildly. Time is the exponent, so starting young is the advantage no one can buy back later."
quiz:
  - q: "You've met compounding three times before this lesson. What's different about it here?"
    options:
      - "Investing uses a completely different kind of math"
      - "Nothing about the engine changes — investing is pointing the same snowball in your favor on purpose, with decades to run"
      - "Compounding only applies to debt, not investments"
      - "Investing removes all the risk from compounding"
    answer: 1
    explain: "It's the same engine from lesson 6.3 (your savings), lesson 7.4 (a card balance, against you), and lesson 9.2 (a student loan in deferment, against you). Investing doesn't change the math — it changes whose side the snowball is on, and gives it the longest runway you'll ever have."
  - q: "The calculator's default scenario — $1,000 to start, $100 a month, 5%, 10 years — ends near what number?"
    options:
      - "About $13,000 — roughly what you put in"
      - "$17,175.26 — your $13,000 of deposits plus about $4,175 of growth"
      - "About $50,000"
      - "Exactly $20,000"
    answer: 1
    explain: "You contribute $13,000 over the decade; compounding at a modest 5% adds $4,175.26 on top, landing at $17,175.26. And 5% is deliberately conservative next to the long-run historical stock average of just over 10% — though that average is not a guarantee."
  - q: "Historically, US stocks have averaged just over 10% a year over the long term. What's the right way to hold that number?"
    options:
      - "It's a guarantee — every year returns about 10%"
      - "It's a historical average, not a guarantee — real years swing wildly, including big down years"
      - "It means you can't lose money after one year"
      - "It only applies to professional investors"
    answer: 1
    explain: "The ~10% figure (roughly 7% after inflation) is an average across many decades of history. Individual years land all over the map — strongly up, strongly down — and nothing promises the future repeats the past. The average is a long-horizon planning idea, never a short-term promise."
  - q: "Why does starting young matter more than starting big?"
    options:
      - "Young people get better interest rates"
      - "Time is the exponent — by the Rule of 72, money doubling every several years stacks more doublings the earlier you start"
      - "It doesn't — only the dollar amount matters"
      - "Investments are free before age 30"
    answer: 1
    explain: "Remember the Rule of 72 from lesson 6.4: 72 ÷ the rate ≈ years to double. Each extra decade of runway is another doubling or more stacked on top of all the previous ones — an advantage that no bigger deposit later can fully buy back."
sources:
  - label: "FINRA — Investing basics: Risk (long-term average annual returns)"
    url: "https://www.finra.org/investors/investing/investing-basics/risk"
  - label: "Investor.gov (SEC) — Compound interest calculator"
...
| --- | --- |
| How much you add monthly | Sets the snowball's size — linear |
| How long you let it run | Sets the doublings — exponential |
| Reacting to every swing | Nothing good — the engine needs to be left alone |
