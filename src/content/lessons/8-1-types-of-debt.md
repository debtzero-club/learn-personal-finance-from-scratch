...
phase: 8
order: 1
title: "The types of debt, and how each works (revolving vs. installment, secured vs. unsecured)"
...
quiz:
  - q: "What makes a debt 'revolving'?"
    options:
      - "It has a fixed end date and equal monthly payments"
      - "You can borrow, repay, and borrow again up to a limit, and the balance carries month to month"
      - "It's backed by your car"
      - "It can never charge interest"
    answer: 1
    explain: "Revolving debt (like a credit card) has a credit limit you can reuse — the balance revolves up and down, with no fixed payoff date. Installment debt is the opposite: a set amount paid off on a schedule."
  - q: "An auto loan is an example of which type?"
    options:
      - "Revolving and unsecured"
      - "Installment and secured"
      - "Revolving and secured"
      - "Installment and unsecured"
    answer: 1
    explain: "An auto loan is installment (fixed amount, fixed payments, fixed end date) and secured (the car backs it — miss payments and the lender can repossess it)."
  - q: "What does 'secured' mean for a debt?"
    options:
      - "The interest rate can never change"
      - "Something you own (collateral) backs the loan, and the lender can take it if you don't pay"
      - "It's guaranteed by the government"
      - "It's safe to ignore"
    answer: 1
    explain: "Secured debt is tied to collateral — a house for a mortgage, a car for an auto loan. Because the lender has something to seize, secured debt usually carries a lower rate than unsecured debt."
  - q: "Why is a credit card often the riskiest kind of debt to carry?"
    options:
      - "It's secured by your paycheck"
      - "It's revolving and unsecured, so it has no payoff schedule forcing progress and usually carries a high rate"
...
| Debt | Balance | Revolving or installment? | Secured or unsecured? | What that means |
| --- | ---: | --- | --- | --- |
| Credit card | $5,000 | Revolving | Unsecured | High rate, no payoff schedule — the one to attack |
| Auto loan | $20,000 | Installment | Secured | Lower rate, pays itself down on a set schedule |
