...
quiz:
  - q: "What order does the 'avalanche' method use?"
    options:
    ...
    answer: 1
    explain: "Avalanche attacks the highest-APR debt first while paying minimums on the rest. Killing the most expensive interest first means you pay the least interest overall."
  - q: "What order does the 'snowball' method use?"
    options:
      - "Highest interest rate first"
      - "Smallest balance first"
      - "Whatever the bank chooses"
      - "Largest balance first"
    answer: 1
    explain: "Snowball attacks the smallest balance first, regardless of rate. You clear a whole debt quickly, get a visible win, then roll its payment into the next one — building momentum."
  - q: "On the sample three-debt set, how do the two methods compare?"
    options:
      - "Avalanche pays $2,209.33 interest vs snowball's $2,308.90 — avalanche saves $99.57"
      - "Snowball is always cheaper"
      - "They cost exactly the same"
      - "Avalanche takes twice as long"
    answer: 0
    explain: "Both finish in the same number of months here, but avalanche pays $2,209.33 in interest vs snowball's $2,308.90 — a $99.57 saving for going highest-rate-first. Snowball, though, clears the smallest debt first."
  - q: "Which method is the 'right' one?"
    options:
      - "Avalanche, always — it's the only correct choice"
      - "Snowball, always"
      - "Whichever one you'll actually stick with to the end — the best plan is the one you finish"
      - "Neither works"
    answer: 2
    explain: "Avalanche wins on pure math, but if the early motivation of snowball keeps you going, that momentum can be worth more than the interest difference. There's no shame in choosing the one that fits how you're wired."
sources:
...
| Method | Attacks first | Total interest | Months to debt-free |
| --- | --- | ---: | ---: |
| **Avalanche** (highest APR first) | The 25.99% credit card | **$2,209.33** | 29 |
| **Snowball** (smallest balance first) | The $1,200 store card | **$2,308.90** | 29 |
