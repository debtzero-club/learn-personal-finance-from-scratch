...
phase: 8
order: 7
title: "Why extra payments crush a loan — and where to aim them"
summary: "A small extra payment hits a loan far harder than you'd expect: just $100 extra a month on the $20,000 auto loan ends it 13 months early and saves $893.74 in interest — because every extra dollar goes straight to principal."
status: complete
mechanics: true
lastReviewed: "2026-06-11"
calculator: amortization
doIt: "Pick one loan and add a fixed extra amount to every payment — even $25 or $50. Set it up as an automatic transfer so it happens without a decision each month. Then watch the payoff date move up."
keepThis: "Extra payments go 100% to principal, so they save interest on every month that follows. On the $20,000 auto loan, +$100/month finishes it in 47 months instead of 60 and saves $893.74 in interest. Aim extra dollars at your highest-rate debt first."
quiz:
  - q: "Why does an extra payment have such an outsized effect?"
    options:
      - "The lender rewards you with bonus points"
      - "Extra payments go entirely to principal, which lowers every future interest charge"
      - "It resets the interest rate to zero"
      - "It doesn't — extra payments barely matter"
    answer: 1
    explain: "Your normal payment is split between interest and principal, but an extra payment skips the interest and goes 100% to principal. That shrinks the balance, which shrinks next month's interest, which means more of every future payment hits principal too."
  - q: "On the $20,000 auto loan at 7%, what does adding $100/month do?"
    options:
      - "Nothing measurable"
      - "Finishes it in 47 months (13 early) and saves $893.74 in interest"
      - "Doubles the total interest"
      - "Extends the loan"
    answer: 1
    explain: "The calculator pins it: +$100/month ends the loan in 47 months instead of 60, and saves $893.74 in interest — a big return for $100 a month."
  - q: "When extra payments matter most, what's the best timing?"
    options:
      - "The very last month"
      - "As early as possible — early extra payments save interest on the most months"
      - "Only after the loan is half paid"
      - "Timing makes no difference"
    answer: 1
    explain: "Because early payments are mostly interest (amortization), an extra dollar early reduces the balance for the longest possible time, saving interest on every remaining month. Early extra beats late extra."
  - q: "If you have several debts, where should an extra payment go?"
    options:
      - "Split evenly across all of them"
      - "At your highest-interest-rate debt first (the avalanche idea), while paying minimums on the rest"
      - "At the newest debt"
      - "At whichever has the biggest balance"
    answer: 1
    explain: "An extra dollar saves the most when it kills the most expensive interest. Aim it at the highest-APR debt first (avalanche from lesson 8.6), keep minimums on the others, then roll it to the next once one is gone."
sources:
